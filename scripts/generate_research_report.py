...
def build_report(out_dir: Path) -> Path:
    ...
    html_parts = [
        ...
        * { box-sizing:border-box; } body { margin:0; background:var(--wash); color:var(--ink); font:16px/1.58 Georgia, 'Times New Roman', serif; }
        ...
        .toc { border-top:1.5px solid var(--ink); border-bottom:1px solid var(--rule); padding:1rem 0 1.1rem; margin:2rem 0 2.4rem; } .toc ol { margin:.4rem 0 0; columns:1; } .toc > ol { padding-left:1.65rem; } .toc .toc-children { margin:.05rem 0 .35rem; padding-left:1.4rem; list-style-type:circle; font-size:.92rem; } .toc .toc-children li { padding:.05rem 0; } a { color:var(--accent); text-decoration:none; } a:hover { text-decoration:underline; }
        ...
        "<nav class='toc' aria-label='Table of contents'><strong class='sans'>Contents</strong><ol><li><a href='#summary'>Summary and current claim</a></li><li><a href='#coverage'>Model and intervention coverage</a></li><li><a href='#interventions'>Intervention definitions</a></li><li><a href='#measurements'>Measurements and estimands</a></li><li><a href='#proofwriter-confirmation'>ProofWriter confirmation</a></li><li><a href='#results-27b'>27B results and uncertainty</a></li><li><a href='#cross-model'>Cross-model comparisons</a><ul class='toc-children'><li><a href='#fig-verbal-cross-model'>Figure: Verbal-report cross-model comparison</a></li><li><a href='#fig-multihop-cross-model'>Figure: Two-hop reasoning cross-model comparison</a></li><li><a href='#fig-flexible-cross-model'>Figure: Flexible-generalization cross-model comparison</a></li></ul></li><li><a href='#paired-contrasts'>Paired per-item contrasts</a><ul class='toc-children'><li><a href='#fig-paired-causal-contrasts'>Figure: Paired per-item contrasts versus logit lens</a></li></ul></li><li><a href='#scaling'>Effectiveness versus model size</a><ul class='toc-children'><li><a href='#fig-parameter-effectiveness'>Figure: Absolute effectiveness versus model size</a></li><li><a href='#fig-parameter-excess-random'>Figure: Excess over random versus model size</a></li><li><a href='#fig-parameter-median-delta'>Figure: Median rank movement versus model size</a></li></ul></li><li><a href='#efficiency'>Creation cost and scaling</a><ul class='toc-children'><li><a href='#fig-efficiency-creation-scaling'>Figure: Exploratory creation efficiency scaling</a></li></ul></li><li><a href='#pile-validation'>Held-out Pile validation</a></li><li><a href='#interpretation'>Interpretation and open questions</a></li><li><a href='#provenance'>Sources and provenance</a></li><li><a href='#documentation'>Documentation and logs</a></li></ol></nav>",
